    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-12 pb-24">
        ...
        {article.article_type === 'video' && article.video_url ? (
          <div className="relative aspect-[2/1] rounded-xl overflow-hidden my-10 bg-black">
        ...
        <div
          ...
          data-article-body
          style={{ fontSize: 'var(--reader-fs, 1.0625rem)', lineHeight: '1.85', fontFamily: 'var(--reader-ff)' }}
