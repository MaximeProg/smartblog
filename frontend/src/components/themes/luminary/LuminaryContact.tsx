            ...
            <div className={hasInfo ? 'lg:col-span-2' : ''}>
              <div className="mb-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <InlineEditable path="template_config.contact.form.title" value={formTitle} editMode={editMode} tag="h2" className="font-serif italic text-2xl text-zinc-900 whitespace-nowrap" />
                  <div className="flex-1 h-px bg-zinc-200" />
                </div>
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  {status === 'error' && <p className="font-sans text-xs text-red-500">{errorMsg}</p>}
                  <button
                    type="submit"
