      ...
      <EditableSection id="about.hero" {...editProps}>
        <section className="relative overflow-hidden bg-slate-950 text-white py-24 px-4">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <InlineEditable
              path="template_config.about.hero.subtitle"
              value={heroSubtitle}
              editMode={editMode}
              tag="p"
            ...
            />
            <InlineEditable
              path="template_config.about.hero.title"
              value={heroTitle}
              editMode={editMode}
              tag="h1"
        ...
        <EditableSection id="about.mission" {...editProps}>
          <section className="max-w-5xl mx-auto px-4 sm:px-6 py-20">
            <div className={missionImageUrl ? 'grid grid-cols-1 lg:grid-cols-2 gap-12 items-center' : 'max-w-4xl'}>
              <div>
                <InlineEditable
                  path="template_config.about.mission.title"
                  value={missionTitle}
                  editMode={editMode}
                  tag="h2"
        ...
        <EditableSection id="about.values" {...editProps}>
          <section className="bg-slate-50 border-y border-slate-100 py-20 px-4">
            <div className="max-w-5xl mx-auto">
              <InlineEditable
                path="template_config.about.values.title"
                value={aboutConfig?.values?.title || t('aboutValuesTitle')}
                editMode={editMode}
                tag="h2"
                className="text-3xl font-black text-slate-900 text-center mb-12"
              />
          ...
          <section className="py-20 px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-14">
                ...
                <InlineEditable
                  path="template_config.about.team.title"
                  value={teamTitle}
                  editMode={editMode}
                  tag="h2"
        ...
        <EditableSection id="about.cta" {...editProps}>
          <section className="bg-slate-950 text-white py-20 px-4 text-center">
            <div className="max-w-2xl mx-auto">
              <InlineEditable
                path="template_config.about.cta.title"
                value={ctaTitle}
                editMode={editMode}
                tag="h2"
