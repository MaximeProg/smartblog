...
const buildSections = (isFr: boolean) => [
  {
    ...
    body: isFr
      ? "En accédant à SmarterBloggers ou en l'utilisant, vous acceptez d'être lié par ces Conditions d'utilisation. Si vous n'acceptez pas, vous ne pouvez pas utiliser notre service."
      : 'By accessing or using SmarterBloggers, you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use our service.',
    items: [],
  },
  {
    icon: Server,
    ...
    body: isFr
      ? "SmarterBloggers est une plateforme SaaS multi-tenant qui permet aux créateurs et aux entreprises de créer, gérer et publier des blogs professionnels avec des outils d'édition, d'analyse et de monétisation."
      : 'SmarterBloggers is a multi-tenant SaaS platform that enables content creators and businesses to create, manage, and publish professional blogs with editing, analytics, and monetization tools.',
    items: [],
  },
  {
    icon: User,
  ...
  },
  {
    ...
    body: isFr
      ? "SmarterBloggers propose des plans gratuits et payants. Les abonnements payants sont facturés mensuellement ou annuellement. Vous pouvez annuler à tout moment ; l'annulation prend effet à la fin de la période en cours."
      : 'SmarterBloggers offers free and paid plans billed monthly or annually. You may cancel at any time; cancellation takes effect at the end of the current billing period.',
    items: [],
  },
  {
    icon: XCircle,
    ...
    body: isFr
      ? "Nous nous réservons le droit de suspendre ou de résilier votre accès à SmarterBloggers en cas de violation de ces conditions. Vous pouvez également résilier votre compte à tout moment depuis les paramètres."
  ...
  },
  {
    ...
    body: isFr
      ? "Dans les limites autorisées par la loi applicable, SmarterBloggers ne sera pas responsable des dommages indirects, accessoires, spéciaux ou consécutifs résultant de l'utilisation ou de l'impossibilité d'utiliser notre service."
      : 'To the maximum extent permitted by applicable law, SmarterBloggers shall not be liable for indirect, incidental, special, or consequential damages arising from use or inability to use our service.',
    items: [],
  },
  {
    icon: Mail,
    ...
    body: isFr
      ? "Pour toute question concernant ces Conditions d'utilisation, contactez-nous à legal@smarterbloggers.com."
      : 'For questions about these Terms of Service, contact us at legal@smarterbloggers.com.',
    items: ['legal@smarterbloggers.com'],
  },
];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white antialiased transition-colors">
      ...
      <PageHero
        ...
        subtitle={isFr
          ? "Les règles qui régissent l'utilisation de SmarterBloggers."
          : 'The rules governing your use of SmarterBloggers.'}
      />
