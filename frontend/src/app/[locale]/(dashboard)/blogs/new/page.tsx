      ...
      const { data } = await tenantsApi.create({
        ...
        template_config: {
          header: {
            ...
            subscribe: { enabled: true, label: 'Subscribe' },
            nav: { links: [{ label: 'Home', url: '/' }, { label: 'About', url: '/about' }, { label: 'Contact', url: '/contact' }] },
          },
          footer: {
            description: `${name} — insights and analysis for professionals.`,
            showCategories: true,
            navLinks: [{ label: 'Home', url: '/' }, { label: 'About', url: '/about' }, { label: 'Contact', url: '/contact' }, { label: 'RSS Feed', url: '/rss.xml' }],
            showSocialLinks: true,
            showNewsletterMini: true,
            newsletterMiniText: 'Get our best articles delivered weekly.',
            copyrightText: 'All rights reserved.',
            showPoweredBy: true,
          },
          home: {
            hero: { enabled: true, sectionTitle: 'Featured' },
            categoriesStrip: { enabled: true, label: 'Explore' },
            newsletter: { enabled: true, title: 'Stay in the loop', description: 'Join our subscribers and get the best articles delivered straight to your inbox every week.', buttonLabel: 'Subscribe', placeholder: 'your@email.com', disclaimer: 'No spam · Unsubscribe anytime' },
            latest: { enabled: true, sectionTitle: 'Latest articles' },
            sidebar: { popularArticles: true, popularTitle: 'Popular articles', categories: true, categoriesTitle: 'Categories', tags: true, tagsTitle: 'Tags', newsletterMini: true },
          },
          about: {
            hero: { enabled: true, title: `About ${name}`, subtitle: 'About', description: 'Discover our story, mission and team.' },
            stats: { enabled: true, items: [{ value: '0', label: 'Articles' }, { value: '0', label: 'Subscribers' }] },
            mission: { enabled: true, title: 'Our mission', description: 'Sharing quality insights with our readers.' },
            values: { enabled: true, title: 'Our values', items: [{ icon: '🎯', title: 'Expertise', description: 'Content written by experts.' }] },
            team: { enabled: false, title: 'Our team', members: [] },
            cta: { enabled: true, title: 'Join our community', description: 'Subscribe to stay updated.', primaryLabel: 'Subscribe', secondaryLabel: 'Our articles' },
          },
          contact: {
            hero: { enabled: true, title: "Let's connect", subtitle: 'Contact', description: 'Have a question? Get in touch.' },
            form: { enabled: true, title: 'Send us a message', namePlaceholder: 'Your name', emailPlaceholder: 'your@email.com', subjectPlaceholder: 'Subject', messagePlaceholder: 'Your message…', submitLabel: 'Send', successMessage: 'Message sent, thank you!' },
            info: { enabled: true, title: 'Contact', email: '', responseTime: 'Response within 48h', showAddress: false, address: '' },
            faq: { enabled: false, title: 'FAQ', items: [] },
          },
          article: {
            progressBar: { enabled: true },
            tableOfContents: { enabled: true, title: 'In this article', minHeadings: 3 },
            share: { enabled: true, title: 'Share', platforms: { twitter: true, linkedin: true, facebook: true, copyLink: true } },
            authorBio: { enabled: true, title: 'About the author' },
            comments: { enabled: false, provider: 'none' },
            relatedArticles: { enabled: true, title: 'Related articles', count: 3 },
          },
        } as any,
      } as any);
