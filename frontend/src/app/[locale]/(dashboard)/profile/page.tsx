          ...
          <div className="px-8 py-8 max-w-2xl">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden mb-4">
              <div className="flex items-center gap-2.5 px-6 py-4 border-b border-slate-100">
                ...
                <h3 className="text-[14px] font-bold text-slate-800">{t('personalInfo')}</h3>
              </div>
              <div className="px-6 py-5 space-y-4">
                <div>
                  <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">{t('displayNameLabel')}</label>
                  <input
                    value={displayName}
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden mb-4">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-[14px] font-bold text-slate-800">{t('changePassword')}</h3>
                </div>
              ...
              {showPwSection && (
                <div className="px-6 pb-5 space-y-4 border-t border-slate-100 pt-4">
                  <div>
                    <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">{t('currentPasswordLabel')}</label>
                  ...
                  <div>
                    <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">{t('newPasswordLabel')}</label>
                  ...
                  <div>
                    <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">{t('confirmPasswordLabel')}</label>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
              <div className="flex items-center gap-2.5 px-6 py-4 border-b border-slate-100">
                ...
                <h3 className="text-[14px] font-bold text-slate-800">{t('accountSection')}</h3>
              </div>
              <div className="px-6 py-5">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 rounded-xl px-4 py-3">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">{t('currentPlanLabel')}</p>
                    <p className="text-[14px] font-bold text-slate-800 capitalize">{user?.plan ?? t('planFree')}</p>
                  </div>
                  <div className="bg-slate-50 rounded-xl px-4 py-3">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">{t('twoFALabel')}</p>
                    <p className="text-[14px] font-bold text-slate-800">{user?.two_fa_enabled ? t('twoFAEnabled') : t('twoFADisabled')}</p>
                  </div>
                </div>
              </div>
            </div>
