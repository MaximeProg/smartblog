...
// Firebase n'est utilisé que pour la connexion Google — l'inscription et la
// connexion par email/mot de passe sont gérées entièrement par notre backend
// (voir authApi.register/loginPassword dans lib/api.ts), y compris la
// vérification d'email et la réinitialisation de mot de passe (via Resend).
