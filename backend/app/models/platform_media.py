...
class PlatformMedia(Base):
    """Médias uploadés par les super admins pour le CMS des pages publiques
    (home/about/...) — indépendant des tenants clients, jamais lié à un blog."""
    ...
    def __repr__(self) -> str:
        return f"<PlatformMedia {self.cloudinary_public_id}>"
